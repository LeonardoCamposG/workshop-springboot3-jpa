...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception { 
		...
		p3.getCategories().add(cat3);		//	Relacionando os produtos a categorias.
		p4.getCategories().add(cat3);
		p5.getCategories().add(cat2);
		
		productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));	// Salvando o relacionamento.
		...
		// não é para chamar o repository do próprio objeto.
		o1.setPayment(pay1);
		// Depois de associar o pagamento ao pedido, o correto é salvar novamente o pedido.
		// Nessa ação, o JPA trata de salvar o pagamento no banco.
